...
#include <stb_image.h>
sve::Texture::Texture(Device& device, const std::string& filepath) :m_device(device) {
...
void sve::Texture::createTextureSampler() {
	m_device.createTextureSampler(textureSampler);
}

void sve::Texture::createTextureImageView() {
	textureImageView = m_device.createImageView(textureImage, VK_FORMAT_R8G8B8A8_SRGB);
}

void sve::Texture::createTextureImage(const std::string& filepath) {
